...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fill.setOnClickListener(view -> {
            User a = new User("Pavel", "Emshanov", "Andreevich");
            User b = new User("Maxim", "Galkin", "Alexandrovich");
            User c = new User("Andrew", "Malahov", "Nikolaevich");
            User d = new User("Nikolay", "Romanov", "Alexandrovich");
            User e = new User("Alexander", "Pushkin", "Sergeevich");
            User f = new User("Michail", "Shufutinsky", "Zaharovich");
            Contacts ca = new Contacts("89307024709", "emshanov9@gmail.com");
            Contacts cb = new Contacts("8(930)703-07-30", "galkin@gmail.com");
            Contacts cc = new Contacts("89999999999", "name@mail.com");
            Contacts cd = new Contacts("8(950)9995665", "pochta@ya.ru");
            Contacts ce = new Contacts("89474799747", "word@word.com");
            Contacts cf = new Contacts("88888888888", "noreply@gmail.com");
            Other oa = new Other("HSE", "Intel");
            Other ob = new Other("HSE", "Epam");
            Other oc = new Other("UNN", "Yandex");
            Other od = new Other("MGU", "Google");
            Other oe = new Other("MIFI", "Swtec");
            Other of = new Other("HSE", "Ozon");
            userDao.insertAll(a, b, c, d, e, f);
            contDao.insertAll(ca, cb, cc, cd, ce, cf);
            otherDao.insertAll(oa, ob, oc, od, oe, of);
            users.addAll(Arrays.asList(a,b,c,d,e,f));
            contacts.addAll(Arrays.asList(ca, cb, cc, cd, ce, cf));
            others.addAll(Arrays.asList(oa, ob, oc, od, oe, of));
            adapter.setNewStates(users, contacts, others);
            adapter.notifyDataSetChanged();
        });
